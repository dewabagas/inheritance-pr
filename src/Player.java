...
public class Player {
    ...
    public void removeItem(Item objItem) { arrItem.remoqve(objItem); } //.remove adalah method array untuk menghappus ietm berdasarkan index yg dikirim lewat parameter objItem
