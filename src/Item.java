...
public class Item {
    ...
    public Item(String nama) {
        ...
        arrAksi.add("Buang item"); // untuk buang item
    }
    ...
    //ipindahkan item dr player ke ruangan (buagn_)
    private void dibuang() {
        System.out.println("Item dibuang player");
        objGameInfo.getObjPlayer().removeItem(this); // remove dari player
        objRuangan.addItem(this); // item yg udh diremove kemudian di add ke ruangan
        objRuangan = null;
    }
